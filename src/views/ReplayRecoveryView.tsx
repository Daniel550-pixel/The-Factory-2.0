  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Left Column: Select Execution to Replay */}
        <div className="lg:col-span-5 space-y-3 font-mono text-xs">
          <span className="font-bold text-neutral-300 uppercase">
            Historical Executions ({executions.length})
          </span>
            ...
            <div className="rounded-xl border border-neutral-800 bg-neutral-900/60 p-5 space-y-4">
              <div className="flex items-center justify-between border-b border-neutral-800 pb-3">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-lg bg-purple-600 hover:bg-purple-500 font-bold text-neutral-950 flex items-center gap-1.5 transition"
                >
              ...
              {/* Step through replay points */}
              <div className="space-y-2">
                <span className="text-[11px] text-neutral-400 uppercase font-bold">
                  Replay Checkpoints (Snapshot vs Replay Output):
                </span>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div
                      key={i}
                      className="p-3 rounded-lg bg-neutral-950 border border-neutral-800 flex items-center justify-between gap-3 text-xs"
                    >
